...
<div class="col-md-12">
  ...
  <div class="box box-info">
    ...
    {!! Form::model($clinic, ['method' => 'PATCH', 'action' => ['DentalClinicsController@update', $clinic->id]]) !!}
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
           {!! Form::text('municipality', null, ['class' => 'form-control', 'id' => 'municipal', 'placeholder' => 'Municipal']) !!}
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
           {!! Form::text('telephone', null, ['class' => 'form-control', 'id' => 'baraphonengay', 'placeholder' => 'Telephone Number']) !!}
          </div>
        </div>
