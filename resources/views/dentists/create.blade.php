...
<div class="col-md-12">
  ...
  <div class="box box-info">
    ...
    {!! Form::open(['url' => 'dental/dentists','class' => 'form-horizontal']) !!}
      <div class="box-body">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <label for="lastname" class="col-sm-2 control-label">Dentist Name: </label>
          <div class="col-sm-10">
           {!! Form::text('dentist', null, ['class' => 'form-control', 'placeholder' => 'Dentist Name: '])!!}
          </div>
        </div>
