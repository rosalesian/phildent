    ...
    {!! Form::model($patient, ['method' => 'PATCH' , 'action' => ['PatientsController@update', $patient->id]]) !!}
      <div class="box-body">
        <div class="form-group">
          <label for="patient_name" class="col-sm-2 control-label">Clinic Name</label>
          <div class="col-sm-10">
           {!! Form::select('clinics', $clinics, null, ['class' => 'js-example-responsive', 'id' => 'clinics_add', 'style' => 'width: 100%']) !!} 
          </div>
        </div>
