...
<html lang="en">
  ...
  <body>
    ...
    <nav id="tf-menu" class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">PHildent</a>
        </div>
    ...
    <div id="tf-home" class="text-center">
        <div class="overlay">
            <div class="content">
                <h1>Welcome on <strong><span class="color">Phildent</span></strong></h1>
    ...
    <div id="tf-works">
        <div class="container"> <!-- Container -->
            ...
            <div id="lightbox" class="row">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 photography web">1
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#">
                                <div class="hover-text">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Clinics</label>
                                   <!--  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email"> -->
                                    {!! Form::select('clinic_id', $clinics, null, ['class' => 'js-example-responsive', 'id' => 'clinics', 'style' => 'width: 100%']) !!} 
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Apointment</label>
                                     {!! Form::select('appointment_id', $services, null, ['class' => 'js-example-responsive', 'id' => 'services', 'style' => 'width: 100%']) !!} 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                   ...
                                   <!--  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email"> -->
                                   {!! Form::select('dentist_id', $dentists, null, ['class' => 'js-example-responsive', 'id' => 'dentist', 'style' => 'width: 100%']) !!} 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  {!! Form::select('product_id', $products, null, ['class' => 'js-example-responsive', 'id' => 'product', 'style' => 'width: 100%']) !!} 
                                </div>
                            </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  {!! Form::select('patient_id', $patients, null, ['class' => 'js-example-responsive', 'id' => 'patient', 'style' => 'width: 100%']) !!} 
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::date('date', null, ['class' => 'form-control',  'id' => 'schedule'])!!}
                                </div>
                            </div>                           
                        </div>
